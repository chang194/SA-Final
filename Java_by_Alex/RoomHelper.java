...
public class RoomHelper {
    ...
    public JSONObject getByID(int id) {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                /** 將每一筆房型資料產生一名新Room物件 */
                room = new Room(room_id, hotel_id, room_type, room_image, room_number, room_price, max_capacity);
    ...
    public JSONObject create(Room room) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `mydb`.`tbl_Room`(`hotel_id`, `room_type`, `room_image`, `room_price`, `max_capacity`, `room_number`)"
                    + " VALUES(?, ?, ?, ?, ?, ?)";
    ...
    public JSONObject update(Room room) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `mydb`.`tbl_Room` SET `room_type` = ?, `room_image` = ?, `room_price` = ?, `max_capacity` = ?, `room_number` = ? WHERE `room_id` = ?";
            /** 取得所需之參數 */
