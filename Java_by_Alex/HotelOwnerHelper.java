...
public class HotelOwnerHelper {
    ...
    public JSONObject getByID(int id) {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                hotelowner = new HotelOwner(hotelowner_id, name, email, password, birthday, intro, modified_time, hotel_id);
    ...
    public JSONObject create(HotelOwner hotelowner) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "INSERT INTO `mydb`.`tbl_Hotelowner`(`hotelowner_name`, `hotelowner_email`, `hotelowner_password`, `modified_time`, `birthday`, `intro`, `hotel_id`)"
                    + " VALUES(?, ?, ?, ?, ?, ?, ?)";
            ...
            Date birthday = java.sql.Date.valueOf(hotelowner.getBirthday());
            String intro = hotelowner.getIntro();
            int hotel_id = hotelowner.getHotelId();
    ...
    public JSONObject update(HotelOwner hotelowner) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `mydb`.`tbl_Hotelowner` SET `hotelowner_name` = ? ,`hotelowner_password` = ? , `modified_time` = ?, `intro` = ? WHERE `hotelowner_email` = ?";
            /** 取得所需之參數 */
            String name = hotelowner.getName();
            String email = hotelowner.getEmail();
            String password = hotelowner.getPassword();
