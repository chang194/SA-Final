...
public class Customer extends Member{
	...
	//revise
	public Customer(int customer_id,String name,String password,String intro){
		super(name,password,intro);
		this.customer_id = customer_id;
	}
	//getdata
	public Customer(int customer_id,String name,String email,String password,LocalDate birthday,String intro,int customer_point,String modified_time){
