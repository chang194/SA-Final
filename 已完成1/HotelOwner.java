...
public class HotelOwner extends Member{
	...
	//revise
	public HotelOwner(int hotelowner_id, String name, String password, String intro) {
		super(name,password,intro);
		this.hotelowner_id = hotelowner_id;
	}
	//getData
	public HotelOwner(int hotelowner_id, String name, String email, String password, LocalDate birthday, String intro, int hotel_id, String modified_time) {
