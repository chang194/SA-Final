...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_FavorateList`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`tbl_FavorateList` ;

CREATE TABLE IF NOT EXISTS `mydb`.`tbl_FavorateList` (
  `favorateList_id` INT NOT NULL AUTO_INCREMENT,
  `journey_id` INT NOT NULL,
  `community_id` INT NOT NULL,
  `customer_id` INT NOT NULL,
  PRIMARY KEY (`favorateList_id`, `customer_id`, `community_id`, `journey_id`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_Room` (
  ...
  `room_image` VARCHAR(30) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_Review` (
  ...
  `customer_id` INT NOT NULL,
  `hotelowner_id` INT NOT NULL,
  `hotel_id` INT NOT NULL,
  `review_date` DATETIME NOT NULL,
  `replied_to_review_id` INT NOT NULL,
  `review_content` TEXT NOT NULL,
  `tbl_Reviewcol` VARCHAR(45) NOT NULL,
